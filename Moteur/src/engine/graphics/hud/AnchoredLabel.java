...
public class AnchoredLabel extends Label implements IAnchored {
	...
	public AnchoredLabel(Supplier<String> text, Anchor anchor, PixelCoordinate offset, Color color,
		...
		this(text, anchor, offset, true, Label.DEFAULT_FONT_NAME, Label.DEFAULT_FONT_SIZE,
				Label.DEFAULT_FONT_STYLE, color, centeredText);
	}

	public AnchoredLabel(Supplier<String> text, Anchor anchor, PixelCoordinate offset, boolean visible,

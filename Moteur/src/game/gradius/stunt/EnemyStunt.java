...
public class EnemyStunt extends Stunt {
	...
	private static Logger logger = LoggerManager.getLogger(EnemyStunt.class.getName());
	...
	protected void collision(Entity other) {
		logger.finer("ENEMY COLLISION avec " + other.name());
	}

	@Override
	protected void collision(List<Entity> entities) {
		logger.finer("ENEMY COLLISION avec plusieurs entités");
	}
